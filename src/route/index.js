...
var header = {
  ...
  salary: '600$ a month',
  address: 'Khreshchatyk, Street, 50, Kyiv, Ukraine',
}
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        {
          name: 'Oxford Eglish school',
          id: 578932,
        },
        {
          name: 'Education Center of Innovation',
          id: 645456,
        },
        {
          name: 'IT-Brains',
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Baclground verification - is a feature that provides users to prove that they are real persons',
                },
                {
